...
public class MyAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		// 给控件赋值
		String string_song = list.get(i).song.toString();
		if (string_song.length() >= 5
			...
			holder.song.setText(string_song.substring(0,
					string_song.length() - 4));
		} else {
			holder.song.setText(string_song);
		}
		if (i == position_flag) {
			switch (Theme) {
			case "blue":
				...
				holder.position.setBackgroundResource(R.drawable.play_small);
				break;
			case "purple":
				...
				holder.position.setText("");
				holder.position
						.setBackgroundResource(R.drawable.play_small_purple);
				break;
			case "green":
				...
				holder.position.setText("");
				holder.position
						.setBackgroundResource(R.drawable.play_small_green);
				break;
			case "red":
				...
				holder.position.setText("");
				holder.position
						.setBackgroundResource(R.drawable.play_small_red);
				break;
			default:
				break;
			}
