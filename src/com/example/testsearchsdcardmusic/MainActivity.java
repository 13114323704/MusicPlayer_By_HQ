...
import com.example.customdialog.CustomDialog.OnClickBtnListener;
import com.example.customdialog.MyDialog;
import com.example.specialtextview.GradientTextView;
import com.example.statusbar.BaseActivity;
import com.example.statusbar.SystemBarTintManager;
import com.example.util.ImageCacheUtil;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onDestroy() {
        ...
        editor.putString("song_name",
                cut_song_name(list.get(currentposition).song));
        editor.putString("song_singer", list.get(currentposition).singer);
    ...
    private void setpopupwindow() {
        ...
        popupWindow = new PopupWindow(popup_layout, LayoutParams.WRAP_CONTENT,
        ...
        relativeLayout_listbg.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                select_localimage.setOnClickListener(new OnClickListener() {
                ...
                use_default.setOnClickListener(new OnClickListener() {
                ...
                select_xhh.setOnClickListener(new OnClickListener() {
        ...
        relativeLayout_skin.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("song_singer",
                        list.get(currentposition).singer);
                editor.putInt("currentposition", currentposition);
        ...
        // 定位至最爱歌曲
        relativeLayout_location.setOnClickListener(new OnClickListener() {
        ...
        relativeLayout_exit.setOnClickListener(new OnClickListener() {
    ...
    private void setClick() {
        ...
        imageview_setting.setOnClickListener(new OnClickListener() {
        ...
        imageview_playstyle.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (play_style) {
                    case 0:
                        imageview_playstyle.setImageResource(R.drawable.cicle);
                        Toast.makeText(MainActivity.this, "单曲循环",
                                Toast.LENGTH_SHORT).show();
                        break;
                    case 1:
                        imageview_playstyle.setImageResource(R.drawable.ordered);
                        Toast.makeText(MainActivity.this, "顺序播放",
                                Toast.LENGTH_SHORT).show();
                        break;
                    case 2:
                        imageview_playstyle.setImageResource(R.drawable.unordered);
        ...
        imageview_location.setOnClickListener(new OnClickListener() {
        ...
        imageView_play.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (string_theme) {
                    case "blue":
                        change_play_image(R.drawable.play, R.drawable.pause);
                        break;
                    case "purple":
                        change_play_image(R.drawable.play_purple,
                                R.drawable.pause_purple);
                        break;
                    case "green":
                        change_play_image(R.drawable.play_green,
                                R.drawable.pause_green);
                        break;
                    case "red":
                        change_play_image(R.drawable.play_red, R.drawable.pause_red);
                        break;
                    default:
                        break;
                }
    ...
    private void initText() {
        ...
        textView1.setText(sharedPreferences.getString("song_name", "歌曲名"));
        textView2.setText(sharedPreferences.getString("song_singer", "歌手"));
    }
    ...
    private void setListView() {
        ...
        listview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                text_main.setText(cut_song_name(list.get(currentposition).song));
                adapter.setFlag(currentposition);
                adapter.notifyDataSetChanged();
            }
        });
        ...
        if (loadDrawable() != null) {
            ...
            listview.setBackground(getResources().getDrawable(R.drawable.xhh));
        } else {
            listview.setBackground(null);
        }
    }
    ...
    private void musicplay(int position) {
        ...
        textView1.setText(cut_song_name(list.get(position).song));
        textView2.setText(list.get(position).singer);
        text_main.setText(cut_song_name(list.get(currentposition).song));
        ...
        switch (string_theme) {
            case "blue":
                ...
                break;
            case "purple":
                imageView_play.setImageResource(R.drawable.pause_purple);
                break;
            case "green":
                imageView_play.setImageResource(R.drawable.pause_green);
                break;
            case "red":
                imageView_play.setImageResource(R.drawable.pause_red);
                break;
            default:
                break;
        }
